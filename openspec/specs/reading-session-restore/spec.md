# reading-session-restore Specification

## Purpose
Preserve reading continuity in the current workspace by restoring the last TXT file and a near-equivalent reading position when the `Log Peak` panel is reopened.
## Requirements
